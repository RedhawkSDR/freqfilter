# REDHAWK Basic Components freqfilter
 
## Description

Contains the source and build script for the REDHAWK Basic Components freqfilter.
...
REDHAWK Basic Components freqfilter is licensed under the GNU Lesser General Public License (LGPL).
