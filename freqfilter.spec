...
pushd python
./reconf
%define _bindir %{_prefix}/dom/components/freqfilter/python
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/%{name}/freqfilter.scd.xml
%{_prefix}/dom/components/%{name}/freqfilter.prf.xml
%{_prefix}/dom/components/%{name}/freqfilter.spd.xml
